...
<ProjectCard active title="Motiion" link="https://motiion.vercel.app" tags={['NextJS 14', 'Tailwind', 'Convex', 'Clerk Auth', 'PWA']}>
  - App to help dancers create portfolios, connect with choreographers, and book gigs.
  - Greenfield v1 build. 
  - Deeply involved in product solutioning with the founders, architected and implemented full app.
  - 7 week build from start to finish.
  <br/>
  [App Teaser](https://motiion.io)
</ProjectCard>

<ProjectCard active title="Mississippi-Lousiana Assisted Living Association" link="https://www.mslala.org/content.asp?contentid=147" tags={['NextJS 14', 'Tailwind', 'OpenAI Assistants API', 'Embedded Apps']}>
  - Custom AI Assistant app build, targeted for members to be able to do targeted research on member documents.
  - Created a dashboard to allow the client to self-serve updates to configuration and review questions asked to plan educational programming.
</ProjectCard>

<ProjectCard active title="Family Care Circle" link="https://familycarecircle.app" tags={['Nativewind', 'NextJS 14', 'Expo 50', 'Expo Router', 'Universal', 'Figma']}>
  ...
  <br/>
  [Pitch Deck](https://familycarecircle.app/pitch)
</ProjectCard>
...
<ProjectCard title="GoodDay Software" link='https://www.gooddaysoftware.com/' tags={['NextJS 13', 'RSC', 'NestJS', 'Shopify', 'Prisma']}>
